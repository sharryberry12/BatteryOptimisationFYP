...
| [tests/](tests/) | Verification suite for the Elermore Vale GLM→OpenDSS translation (unit tests + source-vs-circuit invariants). Run with `python -m pytest`; see [MODEL_VERIFICATION.md](MODEL_VERIFICATION.md). |
