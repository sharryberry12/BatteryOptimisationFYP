...
Virtual Power Plant dispatch**. Read `CLAUDE.md` first for notation and the base formulation.
...
- Directly addresses the **perfect forecast** assumption flagged in `CLAUDE.md` §9
...
### Practical notes
- NEM dispatch interval is **5 minutes**, not 30. Don't hardcode `s = 48` (see `CLAUDE.md` §11).
...
1. **Close the modelling gaps first** (`CLAUDE.md` §9). Add round-trip efficiency and relax
...
- **Profile-to-bus mapping** (`CLAUDE.md` §7). 145 profiles onto ~1,785 loads. Whatever the
